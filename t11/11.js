...
picArray.forEach((pic) => {
  ...
  img.src = pic.image.medium;      // medium image in the card
  img.alt = pic.title;

  const figcap = document.createElement('figcaption');
  figcap.textContent = pic.caption;
  ...
  // 👉 open modal with LARGE image when clicking the article
  article.addEventListener('click', () => {
    dialogImg.src = pic.image.large;   // use the large image
